...
Game <- rbind(KobeBryant_G, JoeJohnson_G, LeBronJames_G, CarmeloAnthony_G, DwightHoward_G, ChrisBosh_G, ChrisPaul_G, KevinDurant_G, DerrickRose_G, DwayneWade_G)
...
myplot(FreeThrowsAttempts/Game)
# You can notice Chris Paul gets few attempts/game

#2. Accuracy of Free Throws
myplot(FreeThrows/FreeThrowsAttempts)

#Chris Paul's accuracy is high with few attempts.
#His team would get more points if he had more free throw attempts. 
#Dwight Howard's free throw accuracy is poor.
#When compared to other players, Dwight Howard's
#Field Goal Accuracy was very high.
...
#We have excluded free throws, this plot now shows us the true representation of player style change.
#We can verify this is the case for all the marks without exception of this plot are between 2 and 3. 
#because of field goals.
#Insights:
...
#   changed his style at all - Consistent player is Dwight Howard always scoring only 2-pointers.
#   probably why Dwight Howard's Free Throw Accuracy is poor during the game.